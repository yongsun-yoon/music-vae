# Copied from https://github.com/magenta/magenta/blob/main/magenta/models/music_vae/music_vae_train.py
...
def _get_input_tensors(dataset, config):
    ...
    sequence_length.set_shape(
        [batch_size] + sequence_length.shape[1:].as_list())
